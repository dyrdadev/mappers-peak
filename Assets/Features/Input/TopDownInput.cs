// GENERATED AUTOMATICALLY FROM 'Assets/Features/CharacterControllerBase/Input/TopDownInput.inputactions'
...
public class @TopDownInput : IInputActionCollection, IDisposable
{
    ...
    public struct CharacterActions
    {
        ...
        public CharacterActions(@TopDownInput wrapper) { m_Wrapper = wrapper; }
